...
<body>
    ...
    <footer>
        <div class="container">
            <ul>
                <li><a href="https://www.google.com/" class="KZ3Wad">Google</a></li>
                <li><a href="https://about.google/" class="KZ3Wad">Tutto su Google</a></li>
                <li><a href="privacy" class="KZ3Wad">Privacy</a></li>
                <li><a href="terms" class="KZ3Wad">Termini</a></li>
            </ul>
            <div class="Fq8qrb"><label for="i3">Cambia lingua:</label><select id="i3">
